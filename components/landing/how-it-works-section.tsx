...
const steps = [
  {
    ...
    description: "Worked on real-world web development projects using modern frontend and backend technologies. Built scalable applications, improved user experiences, and gained practical experience in full-stack software development.",
...
// Full Stack Development`,
  },
  {
    ...
    description: "Designed and actively maintain an open-source AI workflow automation platform featuring agent orchestration, workflow execution, integrations, observability, and automation tooling. Lead project development and community collaboration.",
...
// Open Source`,
  },
  {
    ...
    description: "Building full-stack applications, automation systems, developer tools, and AI-powered solutions while continuously exploring new technologies and contributing to open-source projects.",
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="relative mb-0 lg:mb-0 grid lg:grid-cols-2 gap-4 lg:gap-12 items-end">
          ...
          <div className="overflow-hidden pb-0 lg:pb-32">
            ...
            <h2 className={`text-5xl md:text-6xl lg:text-7xl font-display tracking-tight leading-[1] transition-all duration-1000 delay-100 ${
              isVisible ? "translate-y-0 opacity-100" : "translate-y-16 opacity-0"
            }`}>
              <span className="block">Professional</span>
              <span className="block text-white/40 text-sm md:text-base lg:text-xl font-mono mt-2">Experience</span>
            </h2>
          </div>
